...
export default function FranklinVsNashville() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Franklin vs Nashville", item: canonicalUrl },
    ],
  };
  ...
  const articleSchema = {
    ...
    image: "https://franklintnguide.com/images/franklin-vs-nashville.png",
    url: canonicalUrl,
  ...
  return (
    <PageWrapper>
      <Helmet>
        <title>Franklin TN vs Nashville | Honest Relocation Comparison 2026</title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="Franklin TN vs Nashville | Honest Relocation Comparison 2026" />
        <meta property="og:description" content="Deciding between Franklin and Nashville? Compare cost of living, schools, commute times, and lifestyle to find your perfect fit in Middle Tennessee." />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={canonicalUrl} />
        <meta property="og:image" content="https://franklintnguide.com/images/franklin-vs-nashville.png" />
        <meta property="og:site_name" content="Franklin TN Guide" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Franklin TN vs Nashville | Honest Relocation Comparison 2026" />
        <meta name="twitter:description" content="Deciding between Franklin and Nashville? Compare cost of living, schools, commute times, and lifestyle to find your perfect fit in Middle Tennessee." />
        <meta name="twitter:image" content="https://franklintnguide.com/images/franklin-vs-nashville.png" />
